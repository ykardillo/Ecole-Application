...
<div class="row ">
    <div class="col emp-profile"style="margin: 2%;">
        ...
        @endif
        <form action="/presences/calendar/add/{{$classe->id}}/{{$date_start}}/{{$date_end}}" method="post">
            {{ csrf_field() }}
            {{ method_field('PUT') }}
            <div class="row">
                <div class="col-9">
                    <div class=" d-flex justify-content-end ">
                    <a href="/presences/calendar" class="btn btn-secondary mr-1 "> Retour </a>
                    <button  type="submit" class="btn btn-success float-right">Enregistrer les étudiants présents</button>
                    </div>
                </div>
                <div class="col">
                </div>
